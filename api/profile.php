...
<img align="left" class="fb-image-lg" src="balloon.jpg" alt="Profile image example"/>
...
<p><form action="edit profile.php" method="post"><input type="submit" class="btn btn-info" class="pull-right" value="Edit Profile" align="right"></form></p>
            <p><?php echo $des ?></p>
        </div>
...
$p5=$row['blog_id'];
    ...
    echo"  <tbody>";
       ...
       echo" </tr>";
       echo" <tr>";
        echo"  <td class=\"mdl-data-table__cell--non-numeric\"  align=\"center\">Author: <a href=\"profile.php\">$p1</a><br></br><form action=\"Edit Post.php\" method=\"post\"><input type=\"hidden\" name=\"id\" value=\"$p5\"><input type=\"submit\" class=\"btn btn-info\" value=\"Edit Post\"></form></td>";
