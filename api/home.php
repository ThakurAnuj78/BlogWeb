<html>
  <head>
    ...
    <link rel="stylesheet" href="../css/material.indigo-pink.min.1.0.4.css">
    <!-- Material Design icon font -->
   <!-- <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
...
html{    background:url(../img/background.jpg) no-repeat;
  ...
  <body>
    ...
    <div class="fb-profile">
        <img align="left" class="fb-image-lg" src="../img/indigo.jpg" height="100%" width="100%" alt="Profile image example"/>
        </div>
...
$re="SELECT blog_master.blog_id,blog_title,blog_desc,blog_auther,blog_category,blog_is_active,blog_detail_image,creation_date FROM blog_master,blog_details WHERE blog_master.blog_id=blog_details.blog_id  ORDER BY blog_master.blog_id DESC LIMIT 5";
